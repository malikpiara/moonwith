...
export default function Projects() {
  return (
    ...
    <p>
        Because I don’t want to wait around to get picked, I decided to build or improve a new product (almost) every week. This is a quick overview of the best things I built so far. The best is yet to come.
    </p>
      
      <section>
            
            <h2 className={utilStyles.headingLg} id='upframe'>Upframe (2016-2020)</h2>
            ...
            <h2 className={utilStyles.headingLg}>351, the Portuguese Startup Community</h2>
            ...
            <h2 className={utilStyles.headingLg}>Slack alternative for teams that hate distractions</h2>
